package freestar.freelibrary.persistence;
...
//    }
    ...
    public static void login(String phone, String password) {
        // 存储当前登录的账户, phone password，方便从数据库中查询我的信息
        SharedPreferences settings = Factory.app().getSharedPreferences("ImissU", Context.MODE_PRIVATE);
        // 存储数据
        settings.edit()
                .putString(KEY_USER_ID, phone)
